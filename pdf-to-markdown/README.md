...
You also need Docker running and the image already local — the driver never pulls for you, on purpose (see *Gotchas* in [SKILL.md](./SKILL.md)):
...
If the baseline is good enough, you're done. If not, find your symptom in [SKILL.md](./SKILL.md) — 15 recipes, each one starting from what the broken output looks like.
...
| File | What it is |
|---|---|
| [`SKILL.md`](./SKILL.md) | The skill itself: symptom → diagnosis → fix, plus gotchas and troubleshooting |
